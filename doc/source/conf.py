...
autodoc_mock_imports = ["scipy", "pyobjcryst"]
...
latex_documents = [
    ("index", "diffpy.srfit.tex", "diffpy.srfit Documentation", ab_authors, "manual"),
]
...
man_pages = [("index", "diffpy.srfit", "diffpy.srfit Documentation", ab_authors, 1)]
