...
class TestSGConstraints(unittest.TestCase):
    ...
    def test_DiffPy_constrainAsSpaceGroup(self):
        ...
        sgpars = constrainAsSpaceGroup(
            parset, "P b n m", scatterers=parset.getScatterers()[::2], constrainadps=True
        )
        ...
        for idx, scatterer in enumerate(parset.getScatterers()[::2]):
            ...
            test = False
            for par in [scatterer.U11, scatterer.U22, scatterer.U33, scatterer.U12, scatterer.U13, scatterer.U23]:
                test |= _alltests(par)
